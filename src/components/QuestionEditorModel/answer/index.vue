  ...
  <div class="question-content-warp">
    ...
    <div class="el-tab-panes">
      ...
      <div style="margin-top:10px;">
        <el-checkbox label="小题显示分数"
                     v-model="question.minshowgrade"></el-checkbox>
...
export default {
  ...
  data () {
    return {
      question: new AnswerQuestion(this.questionData.toJSON(), this.sheet),
      error: ''
    }
  },
  ...
  watch: {
    questionData: {
      handler (question) {
        this.question = new AnswerQuestion(question.toJSON(), this.sheet)
      }
    },
